...
////string ConvertDataToString(string[,] data)
////{
////    try
////    {
////        // Convert the 2D array data into a string format
...
////    catch (Exception ex)
////    {
////        Console.WriteLine("Error converting data to string: " + ex.Message);
////        return string.Empty;
////    }
////}
...
//    //    // Create a new Excel part
//    //    WorkbookPart workbookPart = presentationPart.AddNewPart<WorkbookPart>("rId2");
//    //    WorksheetPart worksheetPart = workbookPart.AddNewPart<WorksheetPart>("rId3");

//    //    // Write Excel data to the worksheet part
...
//    //            writer.WriteElement(new Cell(new CellValue(cellValue)));
//    //        }
...
//    //    slidePart1.AddNewPart<EmbeddedObjectPart>("rId2");
//    //    slidePart1.AddNewPart<EmbeddedPackagePart>("rId3");

//    //    workbookPart.CreateRelationshipToPart(worksheetPart);
//    // slidePart1.CreateRelationshipToPart(workbookPart);
...
//    System.IO.Stream data = GetBinaryDataStream(base64ExcelData);
...
//{
//    // Serialize the data into a binary format (e.g., using BinaryFormatter)
//    // Convert the binary data to base64
//    byte[] binaryData = SerializeData(data);
//    return Convert.ToBase64String(binaryData);
//}

//byte[] SerializeData(string[,] data)
//{
//    // Implement your serialization logic here (e.g., using BinaryFormatter)
//    // Serialize the data array into a byte array
//    // Return the byte array
//    // Example: using System.Runtime.Serialization.Formatters.Binary;
...
//void EmbedExcelDataIntoChartPart(ChartPart chartPart, string excelData)
//{
//    try
//    {
//        // Convert the excelData to a byte array
//        byte[] excelDataBytes = System.Text.Encoding.UTF8.GetBytes(excelData);

//        // Convert the byte array to a Base64 string
//        string base64String = Convert.ToBase64String(excelDataBytes);

//        // Embed the Base64-encoded Excel data into the chart part
//        EmbeddedPackagePart embeddedPackagePart = chartPart.AddNewPart<EmbeddedPackagePart>("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "rId1");
//        using (Stream dataStream = GetBinaryDataStream(base64String))
//        {
...
//    catch (Exception ex)
//    {
//        Console.WriteLine("Error embedding Excel data into chart part: " + ex.Message);
//    }
//}

//Stream GetBinaryDataStream(string base64String)
//{
